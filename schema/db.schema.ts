 ...
 */
export function schemaFor(collection_: string): Function {
    return _schemas[collection_];
}
 ...
 * @returns {ForeignData}
 */
export function foreignData(schema: Function, foreign_: string): ForeignData {
    return _foreignData[schema.name][foreign_];
}
